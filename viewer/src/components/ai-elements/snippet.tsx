/**
 * A command to copy: the text and a copy button, one line.
 *
 * Vercel's AI Elements `snippet` (https://elements.ai-sdk.dev/components/snippet),
 * Copyright 2023 Vercel, Inc., Apache License 2.0. Only the import paths are changed.
 */
import {
  InputGroup,
  InputGroupAddon,
