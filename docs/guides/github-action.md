...
| `version` | the tag | complydoc to install. Empty installs the version in the tag the action was used at (`@v0.6.0` installs 0.6.0), or the latest release for any other ref |
