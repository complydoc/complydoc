...
| `version` | the tag | complydoc to install. Empty installs the version in the tag the action was used at (`@v0.4.10` installs 0.4.10), or the latest release for any other ref |
